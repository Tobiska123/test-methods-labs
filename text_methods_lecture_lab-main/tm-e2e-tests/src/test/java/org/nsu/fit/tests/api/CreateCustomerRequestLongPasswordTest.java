...
public class CreateCustomerRequestLongPasswordTest {
    ...
    public void succeedsWith12SymbolPassword() {
        ContactPojo contactPojo = new ContactFixtureBuilder()
                .setPass("abcdefabcdef")
                .build();
    ...
    @Feature("Administrator can create customer")
    @Severity(SeverityLevel.BLOCKER)
    public void failsWith13SymbolPassword() {
        ContactPojo contactPojo = new ContactFixtureBuilder()
                .setPass("abcdefabcdefg")
                .build();
